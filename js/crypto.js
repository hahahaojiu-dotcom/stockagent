...
// 预定义"总排行"和"市值排行"的币种列表（OKX主流交易对，按成交量排序）
const OKX_TOP = ['BTC-USDT','ETH-USDT','SOL-USDT','BNB-USDT','XRP-USDT','DOGE-USDT','ADA-USDT','AVAX-USDT','TRX-USDT','SHIB-USDT','MATIC-USDT','DOT-USDT','LTC-USDT','LINK-USDT','BCH-USDT','UNI-USDT','NEAR-USDT','APT-USDT','ATOM-USDT','XLM-USDT','ETC-USDT','ICP-USDT','FIL-USDT','HBAR-USDT','VET-USDT','ALGO-USDT','EGLD-USDT','XMR-USDT','TON-USDT','SUI-USDT','OP-USDT','ARB-USDT','INJ-USDT','TIA-USDT','SEI-USDT','PEPE-USDT','WIF-USDT','BONK-USDT','FLOKI-USDT','LDO-USDT','RUNE-USDT','PENDLE-USDT','GRT-USDT','FET-USDT','WLD-USDT','TAO-USDT','RNDR-USDT','AR-USDT','DYDX-USDT','GMX-USDT','STRK-USDT','MANTA-USDT','ZK-USDT','IMX-USDT','CRV-USDT','AAVE-USDT','MKR-USDT','SUSHI-USDT','1INCH-USDT','SNX-USDT','YFI-USDT','COMP-USDT','BAL-USDT','CVX-USDT','FXS-USDT','AXS-USDT','SAND-USDT','MANA-USDT','GALA-USDT','ENJ-USDT','BOME-USDT','MEW-USDT','NEIRO-USDT','TURBO-USDT','POPCAT-USDT','PNUT-USDT','ACT-USDT','GOAT-USDT','CAKE-USDT','JOE-USDT','RDNT-USDT','ANKR-USDT','KAVA-USDT','FTM-USDT','ONE-USDT','ZIL-USDT','WAVES-USDT','MINA-USDT','ROSE-USDT','OSMO-USDT','CELO-USDT','OCEAN-USDT','HNT-USDT','LPT-USDT','AKT-USDT','FLUX-USDT','GLM-USDT','API3-USDT','PYTH-USDT','BAND-USDT','UMA-USDT','ONDO-USDT','OM-USDT','PAXG-USDT','XAUT-USDT'];
...
async function loadCrypto(cat) {
  ...
  try {
    if(cat === 'all' || cat === 'mcap') {
      // 并行拉取，总排行100个，市值排行50个
      const pairs = cat==='mcap' ? OKX_TOP.slice(0,50) : OKX_TOP.slice(0,100);
      // 全部并行发出，不等待
      const results = (await Promise.all(
        pairs.map(id => cachedFetch(API.okxTicker(id), 60000).then(d=>d.data?.[0]).catch(()=>null))
      )).filter(Boolean);
      // 按24H成交额排序
      results.sort((a,b) => parseFloat(b.volCcy24h) - parseFloat(a.volCcy24h));
